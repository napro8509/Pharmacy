...
namespace BUS
{
    public class BUS_NhaCungCap
    {
        ...
        public string Get_TaoMaNhaCC()
        {
            return CONGTY.Get_TaoMaNhaCC();
        }
        public bool ThemNhaCungCap(string MaNhaCC, string TenNhaCC, string DiaChi)
        {
            return CONGTY.ThemNhaCungCap(MaNhaCC,TenNhaCC,DiaChi);
        }
        public bool CapNhatNhaCungCap(string MaNhaCC, string TenNhaCC, string DiaChi)
        {
            return CONGTY.CapNhatNhaCungCap(MaNhaCC, TenNhaCC, DiaChi);
        }
    }
}
